...
public:
    ...
    void async_process_request(HTTP_REQUEST_ID request_id, http_request msg, const unsigned long headers_size);
    ...
    {
    public:
        read_headers_io_completion(const http_request &msg, const unsigned long headers_size) 
    ...
    {
    public:
        read_body_io_completion(HTTP_REQUEST request, const http_request &msg)
    ...
    void dispatch_request_to_listener(http_request &request, _In_ http_listener_interface *pListener);
    ...
    {
    public:
        send_response_io_completion(http_response &response)
            : m_response(response), 
    ...
    http::listener::http_windows_server *m_p_server;
};
...
{
public:
    send_response_body_io_completion(http_response &response)
        : m_response(response) 
    {
    }
...
public:
    ...
    virtual pplx::task<void> respond(http_response response);
