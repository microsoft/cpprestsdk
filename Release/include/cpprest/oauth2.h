...
#undef DAT
        ...
        namespace experimental {
            ...
            public:
                ...
                /// Set access token.
                /// </summary>
                /// <param name="access_token">Access token string to
                /// set.</param>
                ...
                /// Set refresh token.
                /// </summary>
                /// <param name="refresh_token">Refresh token string to
                /// set.</param>
                ...
                /// access token.
                /// </summary>
                /// <returns>Lifetime of the access token in seconds or
                /// undefined_expiration if not set.</returns>
                int64_t expires_in() const { return m_expires_in; }
                /// <summary>
                /// Set lifetime of access token (in seconds).
                /// </summary>
                /// <param name="expires_in">Lifetime of access token in
                /// seconds.</param>
            ...
            public:
                ...
                /// string.
                /// </summary>
                /// <param name="generate_state">If true, a new random state()
                /// string is generated
                /// which replaces the current state(). If false, state() is
                /// unchanged and used as-is.</param>
                ...
                /// </summary>
                /// <param name="redirected_uri">The URI where web browser/view
                /// was redirected after resource owner's authorization.</param>
                /// <returns>Task that fetches the token(s) based on redirected
                /// URI.</returns>
                _ASYNCRTIMP pplx::task<void> token_from_redirected_uri(
                ...
                /// </summary>
                /// <param name="authorization_code">Code received via redirect
                /// upon successful authorization.</param>
                /// <returns>Task that fetches token(s) based on the
                /// authorization code.</returns>
                pplx::task<void> token_from_code(
                ...
                /// </summary>
                /// <returns>Task that fetches the token(s) using the refresh
                /// token.</returns>
                ...
                /// Set client secret.
                /// </summary>
                /// <param name="client_secret">Client secret string to
                /// set.</param>
                ...
                /// </summary>
                /// <param name="auth_endpoint">Authorization endpoint URI
                /// string to set.</param>
                ...
                /// </summary>
                /// <param name="token_endpoint">Token endpoint URI string to
                /// set.</param>
                ...
                /// </summary>
                /// <param name="redirect_uri">Redirect URI string to
                /// set.</param>
                ...
                /// </summary>
                /// <param name="scope">Scope string for authorization for
                /// token.</param>
                void set_scope(utility::string_t scope)
                {
                    m_scope = std::move(scope);
                ...
                /// </summary>
                /// <returns>Client state string used in
                ...
                /// </summary>
                /// <param name="state">Client authorization state string to
                /// set.</param>
                ...
                /// Default: False.
                /// </summary>
                /// <param name="implicit_grant">The implicit grant setting to
                /// set.</param>
                ...
                /// Default: True.
                /// </summary>
                /// <param name="bearer_auth">The bearer token authentication
                /// setting to set.</param>
                ...
                /// </summary>
                /// <returns>HTTP Basic authentication setting for token
                /// endpoint.</returns>
                ...
                /// Default: True.
                /// </summary>
                /// <param name="http_basic_auth">The HTTP Basic authentication
                /// setting to set.</param>
                ...
                /// </summary>
                /// <param name="proxy">A reference to the web proxy
                /// object.</param>
            ...
            private:
                ...
                _ASYNCRTIMP pplx::task<void> _request_token(
