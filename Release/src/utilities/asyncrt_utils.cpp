...
std::string windows_category_impl::message(int errorCode) const CASABLANCA_NOEXCEPT
{
...
std::error_condition windows_category_impl::default_error_condition(int errorCode) const CASABLANCA_NOEXCEPT
{
